...
支持开局选择获得资源/属性功能，用于官方开放自定义角色前的代餐，增加重复游玩的趣味性。
资源点数和steam成就挂钩（保底10，和steam成就点数以及游玩时长挂钩，每解锁2个成就配置点+1，每游玩100个小时配置点+1，作为正版玩家个老玩家的福利）。具体可选开局选项见common/common.cpp开头





支持全局加速、临时存档不删除功能，用于提升游玩体验。
